                        ...
                        <div className="row">
                            <div className="col-sm">
                                <table>
                                    <tbody>
                                        <tr>
                                            <td className="tdWidth"><span>Cases</span> </td>
                                            <td> {props.location.cnt.cases} </td>
                                        </tr>
                                        <tr>
                                            <td className="tdWidth"><span>Today Cases </span></td>
                                            <td> {props.location.cnt.todayCases} </td>
                                        </tr>
                                        <tr>
                                            <td className="tdWidth"><span>Deaths </span></td>
                                            <td> {props.location.cnt.deaths} </td>
                                        </tr>
                                        <tr>
                                            <td className="tdWidth"><span>Today Deaths </span></td>
                                            <td> {props.location.cnt.todayDeaths} </td>
                                        </tr>
                                        <tr>
                                            <td className="tdWidth"><span>Recovered </span></td>
                            ...
                            <table>
                                    <tbody>
                                        <tr>
                                            <td className="tdWidth"><span>Today Recovered </span></td>
                                            <td> {props.location.cnt.todayRecovered} </td>
                                        </tr>
                                        <tr>
                                            <td className="tdWidth"><span>Active </span></td>
                                            <td> {props.location.cnt.active} </td>
                                        </tr>
                                        <tr>
                                            <td className="tdWidth"><span>Critical </span></td>
                                            <td> {props.location.cnt.critical} </td>
                                        </tr>
                                        <tr>
                                            <td className="tdWidth"><span>Cases Per One Million </span></td>
                                            <td> {props.location.cnt.casesPerOneMillion} </td>
                                        </tr>
                                        <tr>
                                            <td className="tdWidth"><span>Deaths Per One Million </span></td>
